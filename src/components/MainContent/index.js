        ...
        <main>
            ...
            <div className="projects-container">
                <ul className="grid">
                    ...
                    {listItem("Note Manager Website", "note-manager", "A full-stack project of a Single Page Application.", "Designed with React.js and Node.js.", "Responsive and connected with a databese.", "https://note-manager-app-frontend.vercel.app/")}
                </ul>
            </div>
        </main>
    );
